 ...
 * @since  0.0.1
 */
class SimpleshopControllerProducts extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 *
...
*/
	...
	public function delete()
	{
		...
		$model = $this->getModel('products', 'simpleshopmodel');
		//die(var_dump($recs2));
		...
		JLoader::import( 'usermerkzettel', JPATH_SITE  . '/components/com_simpleshop/models' ); //Call the frontend model directory
		...
		$this->setRedirect(JRoute::_('index.php?option=com_simpleshop&view=products', $msg));
